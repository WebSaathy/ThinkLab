...
function Storesec({ heroProduct }) {
  return (
    <section className="storehero">
      <div className="storehero-text">
        <h1>
          Nexu <span className="span1">ThinkLab </span>{" "}
          <span className="span2">Store</span>
        </h1>
        ...
        <div className="store-buttons">
          ...
          {heroProduct?.Link ? (
            <a href={heroProduct.Link} className="btn2" target="_blank" rel="noreferrer">
              Download Catalog 🡇
            </a>
          ) : (
            <a href="/stores" className="btn2">
              Download Catalog 🡇
            </a>
          )}
        </div>
